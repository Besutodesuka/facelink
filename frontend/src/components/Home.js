...
export default function Home() {
    ...
    return (
        <div className ="first-page">
            {/* <CssBaseline />  */}
            <Typography className = "Big" variant= "h1" align = "center" color = "textPrimary" style = {{marginTop : "100px"}}>Scan Face Project.</Typography>
            <Button  
                variant="contained"  
                style={{backgroundColor: "#335C67",color : "#FFFCD6"}}
                size = "large"
